fun main(){
    ...
    sayHello()
    sayHelloTo("Barry")
    sayHelloToFrom("Barry Allen","Central City")
    println("El doble de 25 es ${ duplicate(25) }")
    val result = divide(99, 15.0)
    println("El resultado de 99/15 es $result")
    println(fullName("Daryl", "Dixon"))

    welcomeToMexico()
    welcomeToMexico("Flash")

    sayHelloToFrom("Heisenberg", "Albuquerque")
    sayHelloToFrom("Ragnar", "Kategat")
}
